...
Public Function ShowFileOpenDialog(lhWndOwner As Long, Optional ByVal sInitDir As String = vbNullString, Optional ByVal sFilter As String = vbNullString) As String
  ...
  Else
    'Cancel Pressed
    ShowFileOpenDialog = vbNullString
  End If
End Function
