    ...
    If mePTColorScheme = ptColorUser Or getStyleByIndex(mInd) = ptVerticalLine Then
        ...
        If tabEnabl(mInd) = True Then
            If mInd = selIndex Then
                ...
                'If Not UserControl.Font Is mFontActive Then
                'Set UserControl.Font = mFontActive
                With UserControl.Font
                    .Bold = mFontActive.Bold
                    .Italic = mFontActive.Italic
                    .Size = mFontActive.Size
                    .Underline = mFontActive.Underline
                    .Weight = mFontActive.Weight
                    .Name = mFontActive.Name
                End With
                'End If
            ElseIf mInd = hoverIndex Then
                ...
                'If Not UserControl.Font Is mFontHover Then
                'Set UserControl.Font = mFontHover
                'End If
                With UserControl.Font
                    .Bold = mFontHover.Bold
                    .Italic = mFontHover.Italic
                    .Size = mFontHover.Size
                    .Underline = mFontHover.Underline
                    .Weight = mFontHover.Weight
                    .Name = mFontHover.Name
                End With
            Else
                mBC1 = BC
                UserControl.FillColor = BC
                UserControl.ForeColor = FC
                'If Not UserControl.Font Is mFont Then
        ...
        Else
            ...
            With UserControl.Font
                .Bold = mFontDisabled.Bold
                .Italic = mFontDisabled.Italic
                .Size = mFontDisabled.Size
                .Underline = mFontDisabled.Underline
                .Weight = mFontDisabled.Weight
                .Name = mFontDisabled.Name
            End With
        End If
    ElseIf mePTColorScheme = ptColorNoteOne Then
        'load color scheme
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    For i = 0 To tabCnt - 1
        ...
        strToolTips(i) = PropBag.ReadProperty("TabToolTip" & i, vbNullString)
        tabTags(i) = PropBag.ReadProperty("TabTag" & i, vbNullString)
    ...
    For i = 0 To tabCnt - 1
        ...
        For z = 1 To mCCount
            If PropBag.ReadProperty("CtlID" & i & "*" & z, vbNullString) <> vbNullString Then
                ctlLst(i).Add PropBag.ReadProperty("CtlID" & i & "*" & z, vbNullString)
                'If i = 0 Then MsgBox PropBag.ReadProperty("CtlID" & i & "*" & z, vbnullstring)
            End If
        Next z
    Next i
    '
...
'    '
    ...
    For i = 0 To tabCnt - 1
        ...
        PropBag.WriteProperty "TabToolTip" & i, strToolTips(i), vbNullString
        PropBag.WriteProperty "TabTag" & i, tabTags(i), vbNullString
    ...
    For i = 0 To tabCnt - 1
        ...
        For z = 1 To ctlLst(i).Count
            PropBag.WriteProperty "CtlID" & i & "*" & z, ctlLst(i).Item(z), vbNullString
        Next z
    Next i
End Sub
...
Private Sub setTabCount()
    ...
    For i = 0 To tabCnt - 1
        ...
        Else
            ...
            tabEnabl(i) = True
            tabVis(i) = True
            strToolTips(i) = vbNullString
            tabTags(i) = vbNullString
        End If
    Next i
End Sub
'
...
Private Function pGetControlId(ByRef oCtl As Control) As String
  ...
  pGetControlId = sCtlName & IIf(iCtlIndex <> -1, iCtlIndex, vbNullString)
End Function
